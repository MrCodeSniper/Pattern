...
public class OrderMaker {
    ...
    public void pushLog(Environment environment){
        pushManagerImpl.execute(environment);
    }
    public void timeLog(Environment environment){
        timerManagerImpl.execute(environment);
    }
    public void webLog(Environment environment){
        webConfigManagerImpl.execute(environment);
    }
